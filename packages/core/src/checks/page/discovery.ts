...
// `discovery.no-duplicate-content` lives in `../site/duplicateContent.ts`.
// It runs as a site-scope, after-pages check because the canonical
// aggregation it needs is only available once every page has been
// fetched.
