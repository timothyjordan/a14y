...
function check(
  ...
  return {
    ...
    status,
    message,
    docsUrl: `https://a14y.dev/scorecards/${scorecardVersion}/checks/${id}/`,
  };
}
...
describe('runToMarkdown', () => {
  ...
  it('groups site checks by their declared group label', () => {
    ...
    expect(md).toContain(
      '- ✅ [`llms-txt.exists`](https://a14y.dev/scorecards/0.2.0/checks/llms-txt.exists/) (pass) — https://example.com/llms.txt',
    );
    expect(md).toContain(
      '- ❌ [`robots-txt.exists`](https://a14y.dev/scorecards/0.2.0/checks/robots-txt.exists/) (fail) — /robots.txt not reachable',
    );
  });
  ...
  it('renders a single-page run with a merged page-checks heading', () => {
    ...
    expect(md).toContain(
      '- ✅ [`html.canonical-link`](https://a14y.dev/scorecards/0.2.0/checks/html.canonical-link/) (pass) — https://example.com/',
    );
  ...
  it('embeds the scorecard version in every check link', () => {
    ...
    expect(md).toContain(
      '[`llms-txt.exists`](https://a14y.dev/scorecards/0.2.0/checks/llms-txt.exists/)',
    );
    expect(md).toContain(
      '[`html.canonical-link`](https://a14y.dev/scorecards/0.2.0/checks/html.canonical-link/)',
    );
  });
});
